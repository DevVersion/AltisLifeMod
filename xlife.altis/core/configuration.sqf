...
__CONST__(life_revive_cops,TRUE); //Isnt Important has been manually added to code...
__CONST__(life_revive_fee,23000); //Fee for players to pay when revived.

//House Limit
__CONST__(life_houseLimit,10); //Maximum amount of houses a player can buy (TODO: Make Tiered licenses).

//Gang related stuff?
__CONST__(life_gangPrice,160000); //Price for creating a gang 
...
[
	...
	["C_Offroad_01_F", 6250],
	["C_Offroad_01_repair_F", 6250],
	["C_SUV_01_F", 16500],
	["C_Van_01_transport_F", 27000],
	["C_Van_01_box_F", 36500],
	["I_Truck_02_transport_F", 83750],
	["I_Truck_02_covered_F", 133250],
	["B_Truck_01_transport_F", 183000],
	["O_Truck_03_transport_F", 500000],
	["B_Truck_01_box_F", 383000],
	["O_Truck_03_device_F", 483000],
	["B_Truck_01_fuel_F", 620000],
	["O_Truck_03_fuel_F", 1440000],
	["C_Offroad_01_F", 6500],
	["B_G_Offroad_01_F",3500],
	["C_Hatchback_01_sport_F",7500],
	["C_Van_01_fuel_F",3850],
	["I_Heli_Transport_02_F",666500],
	["O_MRAP_02_F",65000],
	["B_Heli_Light_01_F",266500],
