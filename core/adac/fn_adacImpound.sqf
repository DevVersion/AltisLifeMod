...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	if((count crew _vehicle) == 0) then
	{
		...
		switch (true) do
		{
			case (_vehicle isKindOf "Car"): {_price = (call life_ADACimpound_car);};
			case (_vehicle isKindOf "Ship"): {_price = (call life_ADACimpound_car);};
			case (_vehicle isKindOf "Air"): {_price = (call life_ADACimpound_air);};
		};
