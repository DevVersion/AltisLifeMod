...
_text ctrlSetStructuredText parseText format["Name: %1<br/>Bank: %2<br/>Geld: %3<br/>Uniform: %4<br/>Weste: %5<br/>Rucksack: %6<br/>Primär: %7<br/>Sekundär: %8<br/>",
_unit getVariable["realname",name _unit],[_ret select 0] call life_fnc_numberText,[_ret select 1] call life_fnc_numberText, _uni,_vest,_bp,_prim,_sec];