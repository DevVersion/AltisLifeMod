		...
		if(playerSide in [west,independent] && vehicle player != player && !life_siren_active && ((driver vehicle player) == player)) then
		{
				...
				else
			{
				...
				if(playerSide == west) then {
					...
					//I do not have a custom sound for this and I really dont want to go digging for one, when you have a sound uncomment this and change medicSiren.sqf in the medical folder.
