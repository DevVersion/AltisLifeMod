...
switch(_shop) do
{
			...
			default {
				["Sanitäter Shop",
					[
						...
						["Medikit",nil,100],
						["NVGoggles",nil,1200],
						["B_Kitbag_cbr","Medic Rucksack",10],
						["U_Rangemaster","Medic Kleidung",10]
					]
				];
			};
		};
	...
	case "adac_shop":
	{
		switch (true) do 
		{
			case (playerSide != east): {"Du bist kein ADAC-Mitglied"};
			default {
				["ADAC Item Shop",
					[
						["ItemGPS",nil,100],
						...
						["FirstAidKit",nil,150],
						["NVGoggles",nil,1200],
						["B_Kitbag_cbr","ADAC Rucksack",10],
						["U_Rangemaster","ADAC Kleidung",10]
					]
				];
			};
		};
	...
	case "cop_sergeant":
	{
		...
		{
			case (playerSide != west): {"Du bist kein Polizist"};
			case (__GETC__(life_coplevel) < 10): {"Du hast nicht den Sergeant Rang"};
			default
			{
				["Altis Sergeant Offizier Shop",
					[
						...
						["NLAW_F",nil,10000],
						["20Rnd_762x51_Mag",nil,120],
						["5Rnd_127x108_APDS_Mag",nil,150]
					]
				];
			};
		};
